...
/**
 * This is the item provider adapter for a {@link mLopsmodel.Pipeline} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PipelineItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Pipeline_name_feature",
								"_UI_Pipeline_type"),
						MLopsmodelPackage.Literals.PIPELINE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Pipeline_version_feature",
								"_UI_Pipeline_type"),
						MLopsmodelPackage.Literals.PIPELINE__VERSION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLopsmodelPackage.Literals.PIPELINE__TRAINING);
			childrenFeatures.add(MLopsmodelPackage.Literals.PIPELINE__DEPENDENCY);
			childrenFeatures.add(MLopsmodelPackage.Literals.PIPELINE__DATAPROCESSING);
			childrenFeatures.add(MLopsmodelPackage.Literals.PIPELINE__DEPLOYMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLopsmodelPackage.Literals.PIPELINE__TRAINING,
				MLopsmodelFactory.eINSTANCE.createTraining()));

		newChildDescriptors.add(createChildParameter(MLopsmodelPackage.Literals.PIPELINE__DEPENDENCY,
				MLopsmodelFactory.eINSTANCE.createDependency()));

		newChildDescriptors.add(createChildParameter(MLopsmodelPackage.Literals.PIPELINE__DATAPROCESSING,
				MLopsmodelFactory.eINSTANCE.createDataProcessing()));

		newChildDescriptors.add(createChildParameter(MLopsmodelPackage.Literals.PIPELINE__DEPLOYMENT,
				MLopsmodelFactory.eINSTANCE.createDeployment()));
	}
