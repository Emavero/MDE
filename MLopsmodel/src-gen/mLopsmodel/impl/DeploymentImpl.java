 ...
 * </p>
 * <ul>
 *   <li>{@link mLopsmodel.impl.DeploymentImpl#getTargetPlatform <em>Target Platform</em>}</li>
 *   <li>{@link mLopsmodel.impl.DeploymentImpl#getScalability <em>Scalability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeploymentImpl extends MinimalEObjectImpl.Container implements Deployment {
	...
	protected EClass eStaticClass() {
		return MLopsmodelPackage.Literals.DEPLOYMENT;
	}
	...
	public void setTargetPlatform(String newTargetPlatform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLopsmodelPackage.DEPLOYMENT__TARGET_PLATFORM,
	...
	public void setScalability(int newScalability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLopsmodelPackage.DEPLOYMENT__SCALABILITY,
					oldScalability, scalability));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case MLopsmodelPackage.DEPLOYMENT__TARGET_PLATFORM:
			return TARGET_PLATFORM_EDEFAULT == null ? targetPlatform != null
					: !TARGET_PLATFORM_EDEFAULT.equals(targetPlatform);
		case MLopsmodelPackage.DEPLOYMENT__SCALABILITY:
