 ...
 * </p>
 * <ul>
 *   <li>{@link mLopsmodel.impl.DataProcessingImpl#getInputPath <em>Input Path</em>}</li>
 *   <li>{@link mLopsmodel.impl.DataProcessingImpl#getOutputPath <em>Output Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataProcessingImpl extends MinimalEObjectImpl.Container implements DataProcessing {
	...
	protected EClass eStaticClass() {
		return MLopsmodelPackage.Literals.DATA_PROCESSING;
	}
	...
	public void setInputPath(String newInputPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLopsmodelPackage.DATA_PROCESSING__INPUT_PATH,
	...
	public void setOutputPath(String newOutputPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLopsmodelPackage.DATA_PROCESSING__OUTPUT_PATH,
